...
//import ArrayImageData from '../AllReports/CardData';
//import CardData from '../AllReports/CardData';
    ...
    return (
      <div className="AllReports-wrapper">
          <div className="AllReports-row">
            ...
            <div className="AllReports-column">
              <p className="AllReports-p"> {patients[5]} </p>
              <img className="AllReports-img" src={ images[5] } alt="Patient's lungs"/>
            </div>
